...
public class gameData
{
	...
	public static Hero chooseClass() throws IOException
	{
		// Function that allows player to choose desired class
		// Returns a string representing the class

		FileReader fr = null;  // Will hold text file with hero information
		BufferedReader br;
